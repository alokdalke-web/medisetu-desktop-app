...
![Pharmacy prescription queue and dispensing](/docs/images/roles/role-pharmacist.svg)
...
> Tip: **At a glance** — your work splits into **dispensing** (prescriptions → invoices) and **inventory** (medicines, stock, suppliers, expiry). Keep the queue moving and the shelves healthy.
...
| **Low Stock Medicines** | Medicines below minimum threshold — need restocking |
...
| **Quick Actions** | Shortcuts to prescriptions, new sale, stock, and more |
