...
![Lab test queue and result entry](/docs/images/roles/role-lab.svg)
...
> Tip: **At a glance** — every test moves through five stages: **Ordered → Sample Collected → In Progress → Completed → Delivered**. Your job is to move each one forward accurately and flag anything critical fast.
...
Supporting panels: **Revenue Overview**, **Top Performing Tests**, **Recent Test Requests**, and **Quick Actions**.
