...
![Admin workspace and sidebar navigation](/docs/images/roles/role-admin.svg)
...
> Tip: **At a glance** — you own four areas: **people** (staff & roles), **operations** (appointments, patients, no-shows), **money** (payments, reports, subscription), and **setup** (clinic config & test catalog). Every section below fits one of these.
...
| ---------------------- | ------------------------------------------ |
| **Total Revenue**      | Revenue with period-over-period comparison |
| **Total Appointments** | Booking count with trend indicator         |
| **Total Patients**     | Patients registered                        |
| **No Shows**           | Patients who missed appointments           |
| **Pending Payments**   | Outstanding amounts not yet collected      |

### Visualizations & Panels

- **Revenue Overview** — Time-series chart with daily/weekly revenue and appointment overlay
- **Appointment Status** — Completed, confirmed, pending, cancelled, no-show counts
- **Top Symptoms** — Most reported symptoms across recent consultations
- **Patient Overview** — Registrations and recent patient interactions for the period
...
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| **Profile → Clinic Details**                                 | Name, address, registration number, contact, hours, working days, logo               |
| **Profile → Services & Price**                               | Service types, duration, and fees (General Consultation, Follow-up, Procedure, etc.) |
| **Configuration → Notification Config** (sidebar)            | Which roles receive which notification types                                         |
| **Profile → Security & Access → Payment History Visibility** | Show or hide payment history/revenue figures across the app                          |
| **Profile → No Show Policy**                                 | Auto-tracking rules and threshold actions                                            |
| **Subscription** (sidebar)                                   | Current plan, feature usage, billing history, upgrade                                |
| **Profile → Security & Access**                              | Password change, active sessions, MFA                                                |
| **Profile → Referral**                                       | Unique referral link, referral status, rewards                                       |

### Services & Specializations

Infinity MediSetu organizes clinical offerings by **services** (defined under Profile → Services & Price) and by each doctor's **specialization** (General Physician, Cardiology, Dermatology, etc., set on the doctor's profile):
- Appointments are booked against a doctor and a service
- Reports can be filtered by service (and by doctor)
- A doctor's specialization is shown wherever the doctor is listed

### Banners & Announcements

Announcement banners (holiday closures, new services, health campaigns, platform updates) are published centrally by the Infinity MediSetu team and appear in your sidebar automatically. To request a banner for your clinic, contact support.
...
- **+91 8770553894** for urgent issues during business hours
