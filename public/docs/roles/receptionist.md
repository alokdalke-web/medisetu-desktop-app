...
![Receptionist appointment list and check-in](/docs/images/roles/role-receptionist.svg)
...
> Tip: **At a glance** — your day revolves around four things: **book** appointments, **check in** arrivals, **process payments**, and **keep the queue moving**. Everything below maps to one of those.
...
| Panel | What It Shows |
|-------|---------------|
| **Today's Appointments** | Live count of visits scheduled today (updates in real-time) |
...
A live **Today's Appointments** list (check-in, reschedule, cancel, mark no-show) and **Quick Actions** shortcuts fill out the rest of the dashboard.
...
![Appointments — switch between list and calendar views, filter, and open any appointment](/docs/images/roles/receptionist-appointments.svg)
...
Go to **Payments History** in the sidebar — filter by date, patient, or payment mode. View and reprint past receipts.
...
| **Profile → Security & Access** | Change password, view active sessions, terminate unrecognized sessions |
