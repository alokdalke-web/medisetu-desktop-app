  ...
  return (
    <div
      className={[
        ...
        "grid grid-rows-[84px_1fr] grid-cols-1 bg-background",
        showRight
    ...
    >
      ...
      >
        ...
        {/* panel */}
        <div
          className={`absolute left-0 top-0 h-full w-72 max-w-[85%] bg-surface shadow-xl ring-1 ring-black/10 transition-transform ${
      ...
      {showRight && (
        ...
        >
          ...
          {/* panel */}
          <div
            className={`absolute right-0 top-0 h-full w-80 max-w-[90%] bg-surface shadow-xl ring-1 ring-black/10 transition-transform ${
