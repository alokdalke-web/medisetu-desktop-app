...
const OnboardingLayoutContent: React.FC = () => {
  ...
  const isReviewStep =
    currentStep === "review" || currentStep === "subscription";
      ...
      {isVerificationStep ? (
        ...
        <aside
          className="
            ...
            xl:flex xl:w-[300px] xl:flex-col
            2xl:w-[390px]
          "
        >
          {/* Image background */}
  ...
  "
          ...
          <div
            className="
              ...
              px-6 pb-[clamp(14px,2.2dvh,20px)]
          ...
          >
            <div className="flex min-h-full flex-col">
              <div>
                <h1
                  className="
                    mb-[clamp(10px,1.8dvh,16px)] max-w-[245px]
                    text-[clamp(23px,3.4dvh,29px)] font-bold
                    leading-[clamp(29px,4.1dvh,37px)] tracking-normal
                    text-slate-950
                    dark:text-slate-50
                    2xl:max-w-[285px] 2xl:text-[clamp(25px,3.4dvh,31px)]
                    2xl:leading-[clamp(31px,4.1dvh,39px)]
                  "
                >
                  {isServicesStep ? (
                    <>
                ...
                <p
                  className="
                    mb-[clamp(12px,2dvh,20px)] max-w-[245px]
      ...
      <div className="flex h-[100dvh] min-h-0 flex-1 flex-col overflow-hidden">
        ...
        {/* Scrollable content */}
        <main className="min-h-0 flex-1 overflow-hidden bg-white dark:bg-[#111726]">
          <div className="flex h-full min-h-0 flex-col">
            <div className="min-h-0 w-full flex-1 p-3 sm:p-4 lg:p-6 2xl:p-8">
              <Outlet />
            </div>
