...
import NewAppointmentWrapper from "../pages/appointment/new-appointment/NewAppointmentWrapper";
...
import OnlineBookingSettings from "../pages/profile/OnlineBookingSettings";
...
import BannerFormPage from "../pages/dashboard/superadmin/BannerFormPage";
...
import DoctorPublicProfile from "../pages/doctorPublic/DoctorPublicProfile";
...
import LabReportTemplates from "../pages/profile/labReportTemplates";
...
export const routes: AppRoute[] = [
  {
    ...
    children: [
      ...
      {
        // Not `public: true` — that flag means guest-only and would bounce
        // logged-in visitors away from a page meant for everyone.
        key: "doctorPublicProfile",
...

      {
        ...
        children: [
          ...
          },
          {
            ...
            path: "lab-report-template",
            element: LabReportTemplates,
          },
          {
  ...
  { key: "accessDenied", path: "access-denied", element: AccessDenied },
