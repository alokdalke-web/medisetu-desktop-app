...
export default function CancellationPolicySettings() {
  ...
  return (
    <div className="bg-surface font-sans text-text">
      <div className="mx-auto px-4 py-4 sm:px-6 sm:py-5">
        ...
        <div className="mb-5 flex items-center gap-3 border-b border-slate-100 px-1 pb-4 sm:px-0">
          ...
          <h2 className="text-[17px] font-semibold text-text sm:text-[20px]">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-slate-200 bg-surface p-4 shadow-sm sm:p-5">
            <h3 className="text-sm font-semibold text-text border-b border-slate-100 pb-2 mb-4 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center justify-between py-1">
                <div>
                  <p className="text-sm font-medium text-text flex items-center gap-2">
                    <LuUser size={16} className="text-text-muted" />
                    Allow Patients to Cancel Online
                  </p>
                  <p className="text-xs text-text-muted mt-0.5">Allows patients to cancel their appointments directly from the mobile app, subject to notice hours and limits.</p>
                </div>
                <button
              ...
              <div className="flex items-center justify-between py-1">
                <div>
                  <p className="text-sm font-medium text-text flex items-center gap-2">
                    <LuStethoscope size={16} className="text-text-muted" />
                    Allow Doctors to Cancel
                  </p>
                  <p className="text-xs text-text-muted mt-0.5">Allows doctors to cancel appointments. This bypasses normal frequency limits but follows reason rules.</p>
                </div>
                <button
              ...
              <div className="flex items-center justify-between py-1">
                <div>
                  <p className="text-sm font-medium text-text flex items-center gap-2">
                    <LuContact size={16} className="text-text-muted" />
                    Allow Receptionist to Cancel
                  </p>
                  <p className="text-xs text-text-muted mt-0.5">Allows receptionists to cancel appointments on behalf of patients or doctors.</p>
                </div>
                <button
              ...
              <div className="flex items-center justify-between py-1">
                <div>
                  <p className="text-sm font-medium text-text flex items-center gap-2">
                    <LuShieldAlert size={16} className="text-text-muted" />
                    Allow Clinic Admin to Cancel
                  </p>
                  <p className="text-xs text-text-muted mt-0.5">Allows clinic administrators to cancel any appointment without restriction.</p>
                </div>
                <button
          ...
          <div className={`rounded-xl border border-slate-200 bg-surface p-4 shadow-sm sm:p-5 transition-opacity duration-200 ${!allowPatientCancel ? "opacity-60 pointer-events-none" : ""}`}>
            <h3 className="text-sm font-semibold text-text border-b border-slate-100 pb-2 mb-4 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-xs font-medium text-text-muted uppercase tracking-wider mb-2 flex items-center gap-1.5">
                  <LuGlobe size={14} className="text-text-muted" />
                  ...
                  <Tooltip
                    ...
                    showArrow
                  >
                    <span className="cursor-help text-text-muted hover:text-text-muted">
                      <LuInfo size={14} />
                    </span>
                  </Tooltip>
                </label>
                <input
                  ...
                  className="h-10 w-full rounded-xl border border-slate-200 bg-surface px-3 text-sm focus:border-teal-500 focus:ring-1 focus:ring-teal-100 focus:outline-none"
                />
              </div>
              <div>
                <label className="block text-xs font-medium text-text-muted uppercase tracking-wider mb-2 flex items-center gap-1.5">
                  <LuHouse size={14} className="text-text-muted" />
          ...
          <div className={`rounded-xl border border-slate-200 bg-surface p-4 shadow-sm sm:p-5 transition-opacity duration-200 ${!allowPatientCancel ? "opacity-60 pointer-events-none" : ""}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
              <div>
                <label className="block text-xs font-medium text-text-muted uppercase tracking-wider mb-2 flex items-center gap-1">
          ...
          <div className="rounded-xl border border-slate-200 bg-surface p-4 shadow-sm sm:p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div className="flex items-center justify-between py-1">
                <div>
                  <p className="text-sm font-medium text-text">Cancellation Reason is Mandatory</p>
                  <p className="text-xs text-text-muted mt-0.5">Requires selecting a cancellation reason from the pre-defined dropdown list.</p>
                </div>
                <button
              ...
              <div className="flex items-center justify-between py-1">
                <div>
                  <p className="text-sm font-medium text-text">Allow Additional Comments</p>
                  <p className="text-xs text-text-muted mt-0.5">Enables typing customized additional comments when cancelling.</p>
                </div>
                <button
            ...
            {allowReschedule && (
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-1">
                  <div>
                    <p className="text-sm font-medium text-text flex items-center gap-2">
                      <LuCreditCard size={16} className="text-text-muted" />
                      Keep existing payments active on reschedule
                    </p>
                    <p className="text-xs text-text-muted mt-0.5">Transfers the patient's payment/deposit to the rescheduled appointment automatically.</p>
                  </div>
                  <button
        ...
        <div className="mt-8 flex items-center justify-between border-t border-slate-100 pt-6">
          <button
            ...
            disabled={isBusy}
            className="flex items-center gap-2 rounded-xl border border-slate-200 bg-surface px-4 py-2.5 text-sm font-semibold text-text-muted shadow-sm transition hover:bg-slate-50 disabled:opacity-50"
          >
            <LuRotateCcw size={16} />
            Reset Defaults
          </button>
