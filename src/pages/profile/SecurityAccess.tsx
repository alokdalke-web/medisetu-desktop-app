...
export default function SecurityAccess() {
  ...
  const hidePaymentHistory = effectiveUserType === "Pharmacist" || effectiveUserType === "Lab_Assistant";
  ...
  const inputClassNames = {
    ...
    inputWrapper:
      "h-11 rounded-lg bg-surface border-default-200 dark:border-[#273244] shadow-none data-[hover=true]:border-default-300 ",
  ...
  const isPending = (userData as any)?.userStatus === "Pending";
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-3 p-4 sm:p-5">
            ...
            <div className="px-4 sm:px-6 py-4 sm:py-5 border-t border-[#E8EEEE] dark:border-[#273244]">
              <div className="space-y-4 sm:space-y-5">
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  >
                    <span
                      className={`inline-block h-4 w-4 rounded-full bg-surface shadow transition-transform ${loginAlertEnabled ? "translate-x-6" : "translate-x-1"
                        }`}
                    />
                  </button>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
                  ...
                  <Select
                    ...
                    classNames={{
                      trigger: "h-9 border-[#E2E8F0] bg-surface dark:border-[#273244] data-[hover=true]:border-primary",
          ...
          {paymentVisibilityOpen && (
            <div className="px-4 sm:px-6 py-4 sm:py-5 border-t border-[#E8EEEE] dark:border-[#273244]">
              <div className="flex items-center justify-between gap-4">
                ...
                >
                  <span
                    className={`inline-block h-4 w-4 rounded-full bg-surface shadow transition-transform ${paymentVisible ? "translate-x-6" : "translate-x-1"
                      }`}
                  />
                </button>
              </div>
        ...
        <div className="rounded-2xl bg-surface border border-[#E8EEEE] dark:border-[#273244] relative overflow-hidden">
          <button
            type="button"
