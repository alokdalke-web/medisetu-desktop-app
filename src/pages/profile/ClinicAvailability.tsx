...
import type { Break } from "../../types/profile";
...
const LeaveHistoryList = ({
  ...
  if (isLoading) {
    return (
      <div className="flex items-center gap-2 rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-500 dark:border-[#334158] dark:bg-[#0f1728] dark:text-text-subtle">
        <Spinner size="sm" />
  ...
  if (!items?.length) {
    return (
      <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-4 py-4 text-sm text-slate-500 dark:border-[#334158] dark:bg-[#0f1728] dark:text-text-subtle">
      ...
      {items.map((item) => {
        ...
        return (
          <div
            ...
            className="rounded-3xl border border-slate-200 bg-surface shadow-sm dark:border-[#334158] dark:bg-[#0f1728]"
          >
            <div className="flex items-center gap-3 px-4 py-4">
              <div
                className={`grid h-10 w-10 place-items-center rounded-2xl ring-1 ${
                  isFullDay
                    ? "bg-slate-50 text-text-muted ring-slate-200 dark:bg-slate-800 dark:text-slate-200 dark:ring-slate-600"
              ...
              <div className="min-w-0">
                ...
                <div className="mt-1 flex flex-wrap items-center gap-2 text-xs">
                  ...
                  {/* <span className="text-text-muted">{rangeText}</span> */}
                </div>
              </div>
            </div>
          </div>
...
const DayRow = ({
  ...
  return (
    <div
      ref={rowRef}
      className={`overflow-hidden rounded-2xl border bg-surface transition-all duration-200 dark:bg-[#0f1728] ${
        isExpanded
    ...
    >
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
                ...
                <span
                  className={`rounded-full px-2 py-0.5 text-[10px] font-semibold ${
                    selected
                      ...
                      : "bg-slate-100 text-slate-500 dark:bg-slate-700 dark:text-text-subtle"
                  }`}
                >
              ...
              <div className="flex flex-wrap items-center gap-2">
                {totalHours > 0 && (
                  <div className="mt-1 text-center text-[10px] text-text">
                  ...
                  {shifts.map((shift, idx) => (
                    ...
                    >
                      <span className="text-text">
                        {idx < shifts.length && (
                          <span className="me-2 text-[10px] text-text-muted">
                            Shift {idx + 1} :
                          </span>
                        )}
        ...
        <div className="flex flex-wrap items-center justify-end gap-2 sm:gap-3">
          {selected && (
            <button
              type="button"
              onClick={handleEdit}
              className="inline-flex h-9 items-center gap-1.5 rounded-xl border border-slate-200 bg-surface px-3 text-xs font-medium text-text transition hover:bg-slate-50 active:scale-[0.98] dark:border-[#334158] dark:bg-[#111a2c] dark:text-white dark:hover:bg-[#17233a] sm:text-sm"
            >
      ...
      {isExpanded && (
        <div className="border-t border-emerald-100 bg-slate-50/80 px-4 py-4 dark:border-[#334158] dark:bg-[#0b1220] sm:px-5">
          ...
          <div className="rounded-2xl border border-slate-200 bg-surface p-3 dark:border-[#334158] dark:bg-[#111a2c] sm:p-4">
...
const ClinicAvailability: React.FC = () => {
  ...
  //             className="inline-flex h-9 items-center gap-1.5 rounded-xl border border-slate-200 bg-surface px-3 text-xs sm:text-sm font-medium text-text transition hover:bg-slate-50 active:scale-[0.98]"
  //           >
  //             <FiEdit2 className="h-3.5 w-3.5" />
  //             {/* Edit day */}
  //           </button>
  ...
  //           <div className="rounded-2xl border border-slate-200 bg-surface p-3 sm:p-4">
  //             <WeeklySlotInlineEditor
  //               slot={slot}
  //               allAvailability={availability}
  //               allDateAvailability={dateAvailability}
  ...
  return (
    <>
      <ProfilePageHeader
        ...
        actions={
          isFetching ? (
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-surface px-3 py-2 text-xs font-medium text-slate-500 dark:border-[#334158] dark:bg-[#0f1728] dark:text-text-subtle">
              <Spinner size="sm" />
              Refreshing
            </div>
          ) : undefined
        ...
        {tab === "weekly" && (
          <>
            ...
            <div className="flex flex-col gap-3">
              {isLoading && (
                <div className="flex items-center gap-2 rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-4 py-4 text-sm text-slate-500 dark:border-[#334158] dark:bg-[#0f1728] dark:text-text-subtle">
                  <Spinner size="sm" />
