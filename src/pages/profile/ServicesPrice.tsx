...
import type { UiService } from "../../types/profile";
  ...
  return (
    <>
      <ProfilePageHeader
        ...
        description="Manage the services you offer, their price and validity."
        actions={
          <>
            <Button
              startContent={<FiPlus />}
      ...
      {/* Content */}
      <div className="px-4 py-4 sm:px-6 sm:py-5 [&_.border-slate-200]:dark:border-[#273244] [&_.bg-slate-50]:dark:bg-[#0f1728] [&_.text-text]:dark:text-text-subtle [&_.text-text-muted]:dark:text-text-muted [&_.text-text]:dark:text-white [&_.bg-surface]:dark:bg-[#111726]">
        {isLoading && !hasServices && (
          <div className="flex items-center gap-2 rounded-xl border border-dashed border-slate-200 bg-slate-50 px-4 py-3 text-xs text-text-muted">
            <Spinner size="sm" />
        ...
        {!isLoading && !hasServices && (
          <div className="rounded-xl border border-dashed border-slate-200 bg-slate-50 px-4 py-4 text-xs text-text-muted">
            <div className="font-medium text-text">No services added yet</div>
            <p className="mt-1">
              ...
              return (
                <Card
                  ...
                  className={[
                    ...
                    isDisabled ? "bg-gray-50 opacity-60" : "bg-surface",
                  ].join(" ")}
                >
                  ...
                  <CardBody>
                    <div className="grid grid-cols-2 gap-3">
                      <div className="rounded-xl border border-default-200 bg-surface px-3 py-2.5 sm:px-4 sm:py-3">
