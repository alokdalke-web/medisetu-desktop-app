  ...
  return (
    <div ref={dropdownRef} className="relative w-full">
      <button
        ...
        className={`flex h-11 w-full items-center justify-between rounded-2xl border bg-surface px-4 text-left shadow-sm transition-all ${
          isOpen
      ...
      {isOpen &&
        ...
        createPortal(
          ...
          >
            <div className="max-h-64 overflow-y-auto rounded-2xl border border-slate-200 bg-surface py-2 shadow-[0_18px_40px_rgba(15,23,42,0.14)]">
              {options.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={`flex w-full items-center justify-between gap-3 px-4 py-3 text-left text-sm transition-colors ${
                      option.disabled
                        ? "cursor-not-allowed bg-surface text-black"
                        : isSelected
...
export default function NoShowPolicySettings() {
  ...
  return (
    <div className="bg-surface font-sans dark:bg-[#111726] dark:text-text-subtle [&_.text-text]:dark:text-white [&_.text-text]:dark:text-text-subtle [&_.text-text-muted]:dark:text-text-subtle [&_.bg-surface]:dark:bg-[#0f1728] [&_.border-slate-200]:dark:border-[#273244] [&_.border-slate-100]:dark:border-[#273244]">
      <ProfilePageHeader
        icon={<img src={warning} alt="" className="w-4" />}
        title="No-Show Policy"
      />
      <div className="mx-auto px-4 py-4 sm:px-6 sm:py-5">
        <div className="mb-6 rounded-xl border border-slate-200 bg-surface p-4 shadow-sm sm:p-5 dark:border-[#273244] dark:bg-[#0f1728]">
        ...
        {isActive && (
          <div className="overflow-visible rounded-xl border border-slate-200 bg-surface shadow-sm">
                        ...
                        <div className="min-w-0 flex-1 pt-1">
                          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:gap-3">
                            <div className="w-full lg:w-48 lg:shrink-0">
                              ...
                              <div className="flex min-h-9 items-center text-sm font-medium text-text-muted">
                                {rule.label}
                              </div>
                            </div>
                              ...
                              {rule.action === "penalty" && (
                                <div className="w-full sm:w-40 lg:w-32 lg:shrink-0">
                                  ...
                                  <input
                                    ...
                                    className="h-11 w-full rounded-2xl border border-slate-200 bg-surface px-4 text-sm text-text shadow-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-teal-100"
                                    placeholder="Amount"
                                  />
                                </div>
                              )}
            ...
            <div className="flex flex-col-reverse gap-3 border-t border-slate-100 bg-slate-50 px-4 py-4 sm:flex-row sm:items-center sm:justify-end sm:px-6">
              <button
                ...
                className="w-full px-4 py-2 text-sm text-text-muted transition-colors hover:text-text sm:w-auto"
              >
                Discard Changes
              </button>
