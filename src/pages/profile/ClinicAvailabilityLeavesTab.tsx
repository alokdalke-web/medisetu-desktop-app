...
import type {
  LeavesTabDateAvailabilityItem as DateAvailabilityItem,
  LeavesTabDraft as Draft,
  ClinicAvailabilityLeavesTabProps as Props,
} from "../../types/profile";
  ...
  return (
    <div className="space-y-4">
      ...
      {!isLoading && allKeys.length === 0 && (
        <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50 p-4 text-sm text-text-muted">
          No leaves added.
        </div>
      )}
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-lg border border-slate-200 bg-surface px-4 py-3 text-sm outline-none focus:border-emerald-300"
                    >
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      classNames={{
                        inputWrapper:
                          "rounded-full border-slate-200 h-12 bg-surface",
                      }}
                    />
                  </div>
                </div>
