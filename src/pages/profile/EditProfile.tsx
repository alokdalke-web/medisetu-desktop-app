...
const EditProfile: React.FC = () => {
  ...
  return (
    <div className="min-w-0">
      <div className="rounded-2xl border border-slate-200 bg-surface shadow-sm overflow-hidden dark:border-[#273244] dark:bg-[#111726] dark:shadow-none">
        <ProfilePageHeader
          icon={<FiUser className="h-4 w-4" />}
          title="Profile Details"
        />

        <form onSubmit={handleSubmit(onSubmit)} className="px-5 sm:px-6 py-6 [&_.text-text]:dark:text-white [&_.text-text]:dark:text-text-subtle [&_.text-text-muted]:dark:text-text-subtle [&_.text-text-muted]:dark:text-text-muted [&_.border-slate-200]:dark:border-[#273244]">
          <div className="space-y-4">
            <div className="flex items-center gap-2 font-semibold text-[13px] text-text">
                ...
                <div className="md:col-span-2">
                  ...
                  <label className="w-[140px] h-[140px] rounded-2xl border border-dashed border-slate-200 bg-slate-50/40 hover:bg-slate-50 cursor-pointer flex flex-col items-center justify-center text-center px-3">
                    ...
                    {photoPreview ? (
                      ...
                      <>
                        <div className="h-9 w-9 rounded-full bg-surface shadow-sm flex items-center justify-center mb-2">
                          <FiUploadCloud className="h-4 w-4 text-primary" />
                        </div>
                        <div className="text-[11px] text-text-muted leading-4">
