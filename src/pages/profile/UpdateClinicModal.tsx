...
import type {
  Break,
  UpdateClinicModalProps as Props,
  UpdateClinicModalFormValues as FormValues,
} from "../../types/profile";
...
const SelectLikeInput = (props: React.ComponentProps<typeof Input>) => {
  return (
    <Input
      ...
      classNames={{
        inputWrapper:
          "h-11 rounded-full bg-surface border-slate-200 shadow-none",
...
const UpdateClinicModal: React.FC<Props> = ({
  ...
  return (
    <Modal
      ...
      placement="center"
      classNames={{
        base: "max-w-[820px] max-h-[92vh] overflow-hidden rounded-3xl bg-surface shadow-2xl flex flex-col",
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl border border-slate-200 bg-surface p-4">
                <div className="mb-3 flex items-center gap-2 text-sm font-semibold text-text">
                  <span className="grid h-8 w-8 place-items-center rounded-xl bg-slate-50 text-text-muted">
                        ...
                        >
                          <div className="mb-3 flex items-center justify-between">
                            <div className="flex items-center gap-2 text-sm font-semibold text-text">
                              <span className="grid h-8 w-8 place-items-center rounded-xl bg-surface text-text-muted border border-slate-200">
                                🍴
                              </span>
                              {t}
                            </div>
                          ...
                          <div className="mt-3 grid gap-3 md:grid-cols-12">
                            <div className="md:col-span-6">
                              <Input
                                ...
                                classNames={{
                                  inputWrapper:
                                    "h-11 rounded-full bg-surface border-slate-200",
                                  label:
