  ...
  <Controller
    ...
    render={({ field, fieldState }) => (
      <Input
        ...
        classNames={{
          input:
            "text-sm font-semibold text-text placeholder:text-text-muted",
          inputWrapper:
            "h-12 rounded-xl border-slate-200 bg-surface shadow-none transition-colors data-[hover=true]:border-primary/40 data-[focus=true]:border-primary group-data-[disabled=true]:border-slate-200 group-data-[disabled=true]:bg-slate-100/80",
        }}
      />
    )}
  />
  ...
  <Controller
    ...
    render={({ field, fieldState }) => (
      <Textarea
        ...
        classNames={{
          input:
            "text-sm font-medium leading-6 text-text placeholder:text-text-muted",
          inputWrapper:
            "rounded-xl border-slate-200 bg-surface shadow-none transition-colors data-[hover=true]:border-primary/40 data-[focus=true]:border-primary",
        }}
      />
    )}
  />
...
const SectionHeader = ({
  ...
  <div className="mb-5 flex items-start gap-3">
    ...
    <div className="min-w-0">
      <h3 className="text-base font-bold leading-6 text-text">{title}</h3>
      {description ? (
  ...
  return (
    <Modal
      ...
      classNames={{
        ...
        body: "p-0",
        closeButton:
          "right-4 top-4 z-30 rounded-full bg-white/90 text-text-muted shadow-sm hover:bg-slate-100 hover:text-text",
      }}
    >
      <ModalContent className="max-h-[94dvh] sm:max-h-[90vh]">
        {() => (
          <form
            ...
            className="flex max-h-[94dvh] min-h-0 flex-col bg-surface sm:max-h-[90vh]"
          >
            <ModalHeader className="shrink-0 border-b border-slate-100 bg-surface px-4 pb-4 pt-4 sm:px-6">
              <div className="flex w-full flex-col gap-4 pr-10 sm:flex-row sm:items-center sm:justify-between sm:pr-12">
                <div className="flex min-w-0 items-start gap-3">
                  ...
                  <div className="min-w-0">
                    <h2 className="truncate text-base  leading-7 text-text sm:text-lg">
                ...
                {/* <div className="flex shrink-0 flex-wrap gap-2">
                  ...
                  {userType ? (
                    <span className="inline-flex items-center rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs font-bold text-text-muted">
                      {userType}
                    </span>
                  ) : null}
                </div> */}
              ...
              <div className="mx-auto flex w-full max-w-5xl flex-col gap-4">
                <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 sm:px-5">
                  <div className="flex items-start gap-3">
                    <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-surface text-amber-600 shadow-sm">
                      ...
                      >
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                          <div className="flex min-w-0 items-center gap-3">
                            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-surface text-sm font-bold text-primary shadow-sm ring-1 ring-slate-200">
                              {index + 1}
                            </span>
                            <div className="min-w-0">
                              <p className="text-sm font-bold text-text">
                          ...
                          <Controller
                            ...
                            render={({ field, fieldState }) => (
                              <Autocomplete
                                ...
                                errorMessage={fieldState.error?.message}
                                startContent={
                                  <FiBookOpen className="h-4 w-4 text-text-muted" />
                                }
                              >
                                {(item) => (
                ...
                <section className="rounded-xl border border-primary/20 bg-surface p-4 shadow-sm sm:p-5">
                  <SectionHeader
                  ...
                  <div className="mt-3 flex items-start gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-medium leading-5 text-text-muted">
            ...
            <ModalFooter className="shrink-0 border-t border-slate-100 bg-surface px-4 py-3 shadow-[0_-8px_24px_rgba(15,23,42,0.06)] sm:px-6 sm:py-4">
              <div className="flex w-full flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="hidden items-center gap-2 text-xs font-semibold text-text-muted sm:flex">
                ...
                <div className="flex w-full flex-col-reverse gap-3 sm:w-auto sm:flex-row sm:justify-end">
                  <Button
                    ...
                    radius="full"
                    variant="bordered"
                    className="border-slate-200 bg-surface px-5 font-semibold text-text"
                    isDisabled={isSaving}
                    onPress={closeModal}
                  >
                    Cancel
