...
import type {
  ExceptionType,
  LeavesInlineEditorFormValues as FormValues,
  LeavesInlineEditorProps as Props,
...
const timeSelectClassNames = {
  trigger:
    "h-11 min-h-11 rounded-lg border border-slate-300 bg-surface px-3 shadow-none data-[hover=true]:border-slate-400",
  value: "text-sm font-medium text-text",
            ...
            <>
              <ModalHeader className="flex items-center justify-between border-b border-slate-200 px-6 py-5">
                ...
                <Button
                  isIconOnly
                  variant="light"
                  className="h-12 w-12 min-w-12 rounded-full border border-slate-200 bg-surface text-text-muted"
                  onPress={onClose}
                >
                ...
                <div className="rounded-[28px] border border-slate-200 p-5">
                  ...
                  <div className="grid grid-cols-7 gap-y-3 text-center">
                    {DAY_LABELS.map((day) => (
                      <div
                        key={day}
                        className="pb-2 text-sm font-semibold text-text-muted"
                      >
                        {day}
                      </div>
                    ))}
                              ...
                              isDisabled
                                ...
                                : isSelected
                                  ...
                                  : isCurrentMonth
                                    ...
                                    : "text-text-subtle hover:bg-slate-50",
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      {fields.map((f, idx) => {
        ...
        return (
          <div
            key={f.fieldId}
            className="rounded-2xl border border-slate-200 bg-surface"
          >
