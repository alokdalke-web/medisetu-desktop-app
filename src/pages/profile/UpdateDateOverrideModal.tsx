...
//       placement="center"
//       classNames={{
//         base: "max-w-[780px] max-h-[90vh] overflow-hidden rounded-3xl bg-surface shadow-2xl flex flex-col",
...
//                     size="sm"
//                     variant="flat"
//                     className="rounded-full bg-slate-100 text-xs font-medium text-text"
//                     startContent={<FiPlus />}
//                     onPress={() =>
//                       append({
//                         // ✅ new slot => no id
...
//                 {fields.length === 0 ? (
//                   <div className="rounded-xl border border-dashed border-slate-300 bg-slate-50 p-3 text-[12px] text-text-muted">
...
//                                 granularity="minute"
//                                 hourCycle={12}
//                                 startContent={<FiClock className="text-text-muted" />}
...
//               </section>
//             ) : (
//               <div className="rounded-xl border border-dashed border-slate-300 bg-surface p-3 text-[12px] text-text-muted">
...
import type {
  ExceptionType,
  UpdateDateOverrideModalFormValues as FormValues,
  UpdateDateOverrideModalProps as Props,
} from "../../types/profile";
...
const UpdateDateOverrideModal: React.FC<Props> = ({
  ...
  return (
    <Modal
      ...
      placement="center"
      classNames={{
        base: "max-w-[900px] max-h-[90vh] overflow-hidden rounded-3xl bg-surface shadow-2xl flex flex-col",
        header: "px-6 pt-5 pb-2 flex-none",
        body: "px-6 pb-4 pt-0 space-y-4 flex-1 min-h-0 overflow-y-auto",
        footer: "px-6 pb-5 pt-3 flex-none",
      }}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col h-full min-h-0">
          <ModalHeader className="flex items-center justify-between">
            <div className="flex flex-col">
              <span className="text-lg font-semibold text-text">Leaves</span>
            ...
            {fields.length === 0 ? (
              ...
              <div className="space-y-4">
                {fields.map((f, idx) => {
                  ...
                  return (
                    <div key={f.fieldId} className="rounded-2xl border border-slate-200 bg-surface p-4">
