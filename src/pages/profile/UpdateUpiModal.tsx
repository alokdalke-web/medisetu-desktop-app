...
import type { UpdateUpiModalProps as Props } from "../../types/profile";
  ...
  return (
    <Modal isOpen={isOpen} onOpenChange={onOpenChange} size="md">
      <ModalContent>
        {(close) => (
          <>
            <ModalHeader className="flex gap-2 items-center text-text">
            ...
            <ModalBody className="gap-4 pb-6">
              ...
              {upiList.length > 0 ? (
                ...
                <div className="rounded-xl border border-dashed border-slate-200 bg-slate-50 px-4 py-6 text-center text-sm text-text-muted mt-2">
