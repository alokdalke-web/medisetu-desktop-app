                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <div className="mt-3 flex flex-wrap gap-10">
                      ...
                      >
                        <span
                          className={`grid h-6 w-6 place-items-center rounded-full border ${field.value === "token"
                              ? "border-emerald-700"
                              : "border-slate-300"
                            }`}
                        >
                          <span
                            className={`h-4 w-4 rounded-full ${field.value === "token"
                                ? "bg-emerald-700"
                                : "bg-transparent"
                              }`}
                          />
                      ...
                      >
                        <span
                          className={`grid h-6 w-6 place-items-center rounded-full border ${field.value === "time"
                              ? "border-emerald-700"
                              : "border-slate-300"
                            }`}
                        >
                          <span
                            className={`h-4 w-4 rounded-full ${field.value === "time"
                                ? "bg-emerald-700"
                                : "bg-transparent"
                              }`}
                          />
