...
export const generateAppointmentInvoiceHTML = (
  ...
  const isPrimaryAlreadyPaid =
    data.isPrimaryAlreadyPaid ||
    String(data.paymentStatus ?? "").trim().toLowerCase() === "already paid" ||
    String(data.paymentMode ?? "").trim().toLowerCase() === "already paid";
