...
export const AppointmentInfoSkeleton = () => (
  <Card shadow="none" radius="lg" className="bg-surface">
...
export const BigSectionSkeleton = ({ title }: { title: string }) => (
  <Card shadow="none" radius="lg" className="bg-surface overflow-hidden dark:bg-[#111726]">
    <div className="border-b border-slate-200 bg-surface dark:border-[#273244] dark:bg-[#111726]">
      <div className="px-4 sm:px-5 py-3">
        <div className="flex items-center gap-2 text-[11px] sm:text-sm font-semibold text-text">
          <span>{title}</span>
        </div>
      </div>
    </div>
