...
import type { ReferFormSectionProps } from "../../../types/appointment";
  ...
  >
    <ModalContent>
      {(onClose) => {
        ...
        return (
          <>
            <div className="flex items-center justify-between border-b border-[#CFEAE5] bg-surface px-4 py-3">
              <div>
            ...
            <ModalBody className="flex min-h-0 flex-col p-0">
              <div className="min-h-0 max-h-[calc(88dvh-68px)] flex-1 overflow-y-auto overscroll-contain bg-[#E8F6F4] sm:max-h-[calc(86dvh-68px)] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[#9ECBC4] [&::-webkit-scrollbar-thumb:hover]:bg-primary">
                <div className="p-2.5 sm:p-3">
                  <div className="rounded-[20px] border border-[#D7ECE7] bg-surface p-4 pr-12 shadow-sm sm:rounded-[22px] sm:p-5 sm:pr-14 lg:p-6 lg:pr-14">
                      ...
                      />
                        ...
                        <div className="mt-2">
                          ...
                          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                            <Input
                              ...
                              classNames={{
                                inputWrapper:
                                  "border-[#D7ECE7] bg-surface shadow-none data-[hover=true]:border-[#BFE0D9]",
                        ...
                        <div className="pt-4">
                          ...
                          <Textarea
                            ...
                            classNames={{
                              inputWrapper:
                                "bg-surface border-[#D7ECE7] shadow-none data-[hover=true]:border-[#BFE0D9]",
                              input: "text-slate-700",
                            }}
                          />
                        </div>
              ...
              <div className="flex flex-col-reverse gap-2 border-t border-line bg-surface/95 px-3 py-3 shadow-[0_-10px_24px_rgba(15,23,42,0.05)] sm:flex-row sm:justify-end sm:px-4">
                <Button
                  radius="full"
                  variant="flat"
                  className="h-10 min-w-[108px] border border-[#D7ECE7] bg-surface px-5 text-slate-700 shadow-none sm:w-auto"
                  onPress={handleClose}
                >
                  Close
                </Button>
                ...
                <Button
                  ...
                  variant="flat"
                  className="h-10 border border-[#BFE0D9] bg-surface px-5 text-primary sm:w-auto"
