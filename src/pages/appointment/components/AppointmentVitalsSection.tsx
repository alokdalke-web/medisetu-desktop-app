...
import type { AppointmentVitalsSectionProps } from "../../../types/appointment";
...
const AppointmentVitalsSection: React.FC<AppointmentVitalsSectionProps> = ({
  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-surface p-3 dark:border-[#273244] dark:bg-[#111726]">
      <div className="flex items-center justify-between gap-3 pb-2 border-b border-line">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <h2 className="truncate text-[13px] font-bold text-text">
            Patient Vitals
          </h2>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <Input
              ...
              type="number"
              endContent={
                <span className="text-[11px] font-medium text-text-muted">mmHg</span>
              }
          ...
          <div>
            <Input
              ...
              type="number"
              endContent={
                <span className="text-[11px] font-medium text-text-muted">bpm</span>
              }
          ...
          <div>
            <Input
              ...
              step="0.1"
              endContent={
                <span className="text-[11px] font-medium text-text-muted">°C</span>
              }
          ...
          <div>
            <Input
              ...
              type="number"
              endContent={
                <span className="text-[11px] font-medium text-text-muted">cm</span>
              }
          ...
          <div>
            <Input
              ...
              type="number"
              endContent={
                <span className="text-[11px] font-medium text-text-muted">kg</span>
              }
