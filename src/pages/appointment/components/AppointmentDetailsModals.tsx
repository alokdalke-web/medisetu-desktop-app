...
import type { AppointmentDetailsModalsProps } from "../../../types/appointment";
  ...
  <>
    ...
    <Modal
      ...
      classNames={{
        ...
        base: "relative m-0 max-h-[90dvh] w-[calc(100vw-24px)] max-w-[1024px] overflow-hidden rounded-[22px] bg-surface shadow-xl sm:max-h-[88dvh] sm:rounded-[26px]",
          ...
          return (
            <>
              <button
                ...
                className="absolute right-4 top-4 z-50 flex h-9 w-9 items-center justify-center rounded-full border border-[#D7ECE7] bg-surface text-slate-500 shadow-[0_8px_24px_rgba(15,23,42,0.12)] transition hover:bg-[#F4FBFA] hover:text-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/30"
                type="button"
              ...
              <ModalBody className="flex min-h-0 flex-col p-0">
                ...
                <div className="min-h-0 flex-1 bg-[#EEF7F6] p-3 sm:p-4">
                  <div className="h-[calc(90dvh-156px)] overflow-hidden rounded-[18px] border border-[#D7ECE7] bg-surface shadow-sm sm:h-[calc(88dvh-164px)]">
                    <iframe
                ...
                <div className="flex flex-col-reverse gap-2 border-t border-[#D7ECE7] bg-surface px-4 py-3 shadow-[0_-10px_24px_rgba(15,23,42,0.05)] sm:flex-row sm:justify-end sm:px-6">
                  <Button
                    radius="full"
                    variant="bordered"
          ...
          <>
            <ModalBody className="p-6">
              ...
              <Textarea
                ...
                classNames={{
                  inputWrapper:
                    "border-slate-200 bg-surface shadow-none data-[hover=true]:border-slate-300",
                }}
              />
              {adminConfirmError && (
              ...
              <div className="flex gap-3 mt-6">
                <AppButton
                  ...
                  className="w-1/2 bg-surface border border-neutral-300 text-slate-600"
                />
                <AppButton
