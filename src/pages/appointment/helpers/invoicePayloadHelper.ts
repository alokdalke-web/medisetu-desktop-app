...
export const buildAppointmentInvoicePayload = ({
  ...
  const isPrimaryAlreadyPaid =
    ...
    String(paymentMode ?? "").trim().toLowerCase() === "already paid";

  const primaryPrice = isPrimaryAlreadyPaid ? 0 : primaryServicePriceValue;
