...
export const buildConfirmationData = ({
  ...
  return {
    ...
    // Left empty rather than defaulted to "Not required" — an empty mode on a
    // chargeable service is what tells the confirm modal to show its inline
    // payment picker. The modal decides how to label a genuinely-empty one.
    paymentMode: pendingAppointmentData.paymentMode || "",
