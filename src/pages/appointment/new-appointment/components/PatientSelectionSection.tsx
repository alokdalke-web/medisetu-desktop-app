...
import type { PatientSelectionSectionProps } from "../../../../types/appointment";
      ...
      render={({ field, fieldState }) => {
        ...
        if (selectedOption) {
          ...
          return (
            <div ref={patientFieldRef} className="min-w-0">
              ...
              <div className="h-10 rounded-lg border border-line bg-surface px-3 flex items-center justify-between shadow-sm">
        ...
        return (
          ...
          >
            ...
            <div
              className={[
                "flex h-10 items-center gap-2 rounded-lg border bg-surface px-3 shadow-sm transition-colors",
                fieldState.error
            ...
            >
              ...
              <input
                ...
                aria-label="Search by patient name or phone"
                value={inputValue}
                ...
                className="min-w-0 flex-1 bg-transparent text-[13px] text-slate-800 outline-none placeholder:text-text-muted"
              />
              {inputValue && (
                <button
                  type="button"
            ...
            {/* Dropdown */}
            {isOpen && (
              <div className="absolute z-50 mt-1.5 w-full overflow-hidden rounded-xl border border-line bg-surface shadow-xl">
                {/* Loading */}
                {isFetchingPatients && patientOptions.length === 0 && (
                ...
                {showResults && (
                  ...
                  >
                    <div className="px-1 pb-1.5 pt-0.5 text-[11px] font-bold text-text-muted">
                          ...
                          <button
                            ...
                            className={[
                              ...
                              isActive
                                ...
                                : "border-slate-200 bg-surface hover:border-teal-200 hover:bg-teal-50/40 dark:border-[#38445a] dark:hover:border-[#46beae]/40 dark:hover:bg-[#1a3a35]/40",
                            ].join(" ")}
                          >
                            <div
                              className={[
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <div className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-0.5 text-[11px] font-medium text-text-muted">
                                {meta.map((item) => (
                ...
                {showEmpty && (
                  <div className="p-3">
                    <div className="mb-0.5 text-[12px] font-semibold text-text-muted">
                      No patient found
