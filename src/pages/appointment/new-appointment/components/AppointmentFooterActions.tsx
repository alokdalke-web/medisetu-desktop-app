...
import type { AppointmentFooterActionsProps } from "../../../../types/appointment";
    ...
    <>
      ...
      <div className="hidden sm:flex items-center justify-end mt-4 gap-2">
        <button
          type="button"
          onClick={onCancel}
          className="rounded-full border border-teal-600 bg-surface px-4 py-2 text-sm font-medium text-teal-700 hover:bg-teal-50 disabled:opacity-70 cursor-pointer dark:border-[#46beae] dark:text-[#46beae] dark:hover:bg-[#1a3a35]"
