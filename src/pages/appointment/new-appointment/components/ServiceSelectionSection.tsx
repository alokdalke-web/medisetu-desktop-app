...
import type { ServiceSelectionSectionProps } from "../../../../types/appointment";
            ...
            <div className="mb-0">
              ...
              <Select
                ...
                classNames={{
                  base: "block w-full",
                  trigger:
                    "!h-10 !min-h-10 items-center !rounded-lg border border-slate-200 bg-surface px-3 py-0 shadow-sm " +
                  ...
                  value: "w-full truncate text-[13px] leading-5 text-slate-800 placeholder:text-text-muted",
