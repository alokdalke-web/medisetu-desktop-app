            ...
            <div>
              <div className="flex flex-wrap items-center gap-2">
                ...
                <LabScreenInfoTooltip
                  title="Add Lab Test"
                  description="Use this screen to add a test that is missing from this lab catalog or needs setup for your department. Save accurate department, sample type, price, and status details before using it in patient or walk-in requests."
                  items={[
                    "Existing master tests may auto-fill department, code, and sample type.",
                    "After saving, manage report fields when the matching result template is available.",
                  ]}
                  placement="right"
