...
function MobileTestCard({
  ...
  return (
    <motion.article
      ...
      className={`min-w-0 overflow-hidden rounded-2xl border border-slate-200 bg-white p-3 shadow-[0_14px_40px_rgba(15,23,42,0.06)] sm:rounded-[24px] sm:p-4 ${
    ...
    >
      ...
      <div className="mt-3 grid grid-cols-1 gap-2 text-xs min-[360px]:grid-cols-2 sm:mt-4 sm:gap-3">
        <div className="min-w-0 overflow-hidden rounded-xl bg-slate-50 px-3 py-2 sm:rounded-2xl">
        ...
        <div className="min-w-0 overflow-hidden rounded-xl bg-slate-50 px-3 py-2 sm:rounded-2xl">
          ...
          <p
            className="mt-1 truncate font-black text-slate-800"
      ...
      {mode !== "all" && (
        <div className="mt-3 flex min-w-0 items-center justify-between gap-2 rounded-xl bg-slate-50 px-3 py-2 sm:mt-4 sm:rounded-2xl">
  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        <div
          className={`min-w-0 overflow-hidden flex flex-col gap-3 text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between ${
            isCardView
        ...
        <div className="flex min-w-0 flex-wrap items-center gap-2">
          ...
          <span className="rounded-lg border border-slate-200 bg-white px-2.5 py-2 text-[11px] font-bold text-slate-600 sm:hidden">
            {page}/{totalPages}
          </span>
          ...
          {getPaginationRange(page, totalPages).map((item, index) => {
            if (item === "...") {
              return (
                <span
                  key={`ellipsis-${index}`}
                  className="hidden h-9 w-9 place-items-center text-slate-400 font-bold sm:grid"
                >
                  ...
                </span>
              );
            ...
            return (
              <button
                ...
                type="button"
                onClick={() => onPageChange(pageNum)}
                className={`hidden h-9 min-w-9 place-items-center rounded-xl font-bold transition-all duration-200 cursor-pointer sm:grid ${
                  isActive
