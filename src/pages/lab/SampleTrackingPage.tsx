...
const SAMPLE_TRACKING_BACK_TO = "/lab/assigned";
...
const SampleTrackingPage = () => {
  ...
  const sampleTrackingCrumbs = [
    { label: "Active Tests", to: SAMPLE_TRACKING_BACK_TO },
    { label: appointmentTest?.testName || "Sample Tracking" },
  ];
  ...
  if (isLoading) {
    return (
      <div className="mx-auto flex w-full flex-col gap-4">
        <PageBackNav
          backTo={SAMPLE_TRACKING_BACK_TO}
          crumbs={sampleTrackingCrumbs}
          className="mb-0"
        />
    ...
    return (
      <div className="mx-auto flex w-full flex-col gap-4">
        ...
        <div className="mx-auto max-w-3xl rounded-xl border border-slate-200 bg-white p-8 text-center shadow-sm">
          ...
          <button
            type="button"
            onClick={() => navigate(SAMPLE_TRACKING_BACK_TO)}
    ...
    <div className="mx-auto flex w-full flex-col gap-4">
      ...
      <div className="grid items-start gap-4 xl:grid-cols-[minmax(0,1fr)_360px]">
        <div className="flex min-w-0 flex-col gap-4">
          ...
          <motion.section
            ...
            className="overflow-hidden rounded-xl border border-slate-200/80 bg-gradient-to-r from-primary/5 via-white to-white shadow-[0_10px_28px_rgba(15,23,42,0.045)]"
          >
            <div className="flex flex-col gap-3 px-4 py-4 md:flex-row md:items-center md:justify-between">
              <div className="flex min-w-0 items-start gap-3">
                <div className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-primary/10 text-primary ring-1 ring-primary/10">
                  <FiFileText />
                </div>
              ...
              <div className="flex shrink-0 flex-wrap gap-2 sm:flex-nowrap sm:items-center">
                ...
                {!isPaid && nextAction?.key !== "MARK_PAYMENT_PAID" && (
                  <button
                    type="button"
                    onClick={() => {
                      setPaymentAmountInput(payment?.amount ?? appointmentTest?.price ?? 0);
          ...
          {showManualReportCard ? (
            <div className="flex min-w-0 flex-col gap-3">
              {(reportWorkspaceTabs.length > 1 || showUploadReportTab) && (
                <div className="inline-flex max-w-full rounded-xl border border-slate-200/80 bg-white p-1 shadow-sm">
                  <div
                    role="tablist"
                      ...
                      return (
                        ...
                        >
                          <span className="inline-flex min-w-0 items-center gap-1.5">
                            <span
                              className={[
                                "grid h-6 w-6 shrink-0 place-items-center rounded-xl text-xs",
                                isActive
      ...
      <Modal
        ...
        classNames={{
          ...
          base: "w-[calc(100%-2rem)] max-w-[420px] rounded-xl border border-slate-200 bg-white shadow-[0_24px_70px_rgba(15,23,42,0.28)]",
          closeButton:
        ...
        <ModalContent>
          <ModalHeader className="px-5 pb-2 pt-5">
            <div className="flex min-w-0 items-start gap-3 pr-8">
              <div className="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-primary text-xl text-white shadow-[0_10px_24px_rgba(10,108,116,0.22)]">
                <FiCreditCard />
              </div>
              <div className="min-w-0">
          ...
          <ModalBody className="gap-4 px-5 py-3">
            ...
            <div className="grid grid-cols-2 gap-3.5">
              ...
              <button
                ...
                className={[
                  "flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all duration-300 relative overflow-hidden group cursor-pointer focus:outline-none disabled:cursor-not-allowed",
                  paymentMethodSelection === "CASH"
                    ? "border-primary bg-primary/5 shadow-[0_0_15px_rgba(10,108,116,0.15)]"
                    : "border-slate-200 bg-white hover:border-slate-300 hover:bg-slate-50/50"
                ].join(" ")}
              >
                {paymentMethodSelection === "CASH" && (
                  <span className="absolute top-2 right-2 text-primary bg-primary/10 rounded-full p-0.5 border border-primary/20">
                    <FiCheckCircle className="h-4.5 w-4.5 stroke-[2.5]" />
                  </span>
                )}
                <div className={[
                  "grid h-12 w-12 place-items-center rounded-xl text-xl mb-2.5 transition-all duration-300",
                  paymentMethodSelection === "CASH"
                    ? "bg-primary text-white shadow-[0_8px_20px_rgba(10,108,116,0.25)]"
      ...
      <Modal
        ...
        classNames={{
          backdrop: "bg-slate-950/45 backdrop-blur-[2px]",
          base: "w-[calc(100%-2rem)] max-w-[420px] rounded-xl border border-slate-200 bg-white p-5 shadow-[0_24px_70px_rgba(15,23,42,0.28)]",
          closeButton:
            "right-4 top-4 h-8 w-8 rounded-full border border-slate-200 bg-white text-slate-400 shadow-sm hover:bg-slate-50 hover:text-slate-700",
        }}
      >
          ...
          <ModalBody className="gap-4 px-5 py-3 text-center">
            ...
            {barcodeValue && (
              <div className="space-y-2 mt-2">
                <div className="mx-auto w-full max-w-[260px] border border-slate-200 rounded-xl p-4 bg-slate-50/70 shadow-inner flex flex-col items-center gap-1.5">
          ...
          <ModalFooter className="justify-stretch gap-3 px-5 pb-5 pt-3">
            ...
            {barcodeValue && (
              <Button
                ...
                className="h-9 flex-1 bg-primary hover:bg-primary-active px-5 text-xs font-semibold text-white shadow-[0_10px_22px_rgba(10,108,116,0.22)]"
