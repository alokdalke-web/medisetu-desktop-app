...
import type { PatientFormSectionsProps } from "../../../types/patient";
...
const PATIENT_NAME_MAX_LENGTH = 50;

function formatPatientName(value: string) {
  return capitalizeWords(
    value.replace(/[^A-Za-z ]/g, "").slice(0, PATIENT_NAME_MAX_LENGTH),
  );
}
  ...
  return (
    <div className="mb-4 flex items-center gap-3 sm:mb-5">
      ...
      <div className="min-w-0">
        <h2 className="text-[13px] font-semibold text-text sm:text-[14px]">
          {title}
        </h2>
        {subtitle && (
...
const PatientFormSections: React.FC<PatientFormSectionsProps> = ({
  ...
  return (
    <div className="w-full space-y-4 sm:space-y-5">
      ...
      <section className="rounded-xl border border-slate-200 bg-surface p-4 shadow-sm sm:rounded-2xl sm:p-5 lg:p-6 dark:bg-[#111726] dark:border-[#273244]">
        <SectionHeader
          icon={<FiUser />}
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:items-start">
          ...
          >
            <InputField
              ...
              parse={formatPatientName}
              onInput={(e) => {
                const target = e.target as HTMLInputElement;
                target.value = formatPatientName(target.value);
              }}
            />
          </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5">
          ...
          >
            <InputField
              ...
              startContent={
                <span className="pointer-events-none text-[12px] font-medium text-text-muted">
                  +91
                </span>
              }
      ...
      <section className="overflow-hidden rounded-xl border border-slate-200 bg-surface shadow-sm sm:rounded-2xl dark:bg-[#111726] dark:border-[#273244]">
        <button
          type="button"
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 sm:items-start">
                ...
                <div className="min-w-0">
                  <InputField
                    ...
                    type="number"
                    endContent={
                      <span className="pointer-events-none text-[11px] font-medium text-text-muted">
                        cm
                      </span>
                    }
                    rules={{
