...
const PatientInfoSkeleton = () => (
  <Card shadow="none" radius="lg" className="border border-line bg-surface">
...
const PatientDetails: React.FC = () => {
  ...
  const [patient, setPatient] = React.useState({
    ...
    contact: "—",
    altContact: null as string | null,
  ...
  React.useEffect(() => {
    ...
    setPatient({
      ...
      altContact: p?.alternateMobile ?? p?.altPhone ?? null,
      ...
      lastVisit: p?.lastVisit ? fmtDate(p.lastVisit) : "No Visits Yet",
  ...
  const rawPForCloud = (rawPatientData as any)?.result?.patient ?? (rawPatientData as any)?.result ?? (rawPatientData as any);
  const cloudId = rawPForCloud?.cloud_id ?? rawPForCloud?.cloudId ?? rawPForCloud?.id ?? rawPForCloud?._id;
      ...
      <div className="space-y-3">
              ...
              <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
                ...
                <div className="flex flex-1 items-start gap-3">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    {/* Demographics line */}
                    <div className="text-sm font-medium text-[#677294] mt-0.5">
                    ...
                    <div className="pt-1.5">
                      <Button
                        variant="bordered"
                        radius="full"
                        className="border-line text-text h-7 text-xs px-3"
                ...
                <div className="border-t pt-3 lg:border-t-0 lg:border-l lg:border-black/10 lg:pt-0 lg:pl-6 lg:w-[420px] shrink-0">
                  <div className="grid grid-cols-2 gap-4 py-2">
                    ...
                    <div>
                      <div className="text-xs text-[#677294]">
                        Registered On
                      </div>
                      <div className="mt-0.5 text-sm font-medium text-text">
                        {patient.createdAt}
        ...
        <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
          ...
          <div className="flex items-center justify-between rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-3 shadow-sm">
            <div>
              ...
              <div className="mt-1 text-sm font-medium text-[#677294]">
                Total Appointments
              </div>
            </div>
          ...
          <div className="flex items-center justify-between rounded-xl border border-amber-500/20 bg-amber-500/5 p-3 shadow-sm">
            <div>
              <div className="text-2xl font-semibold text-text">
                {patient.totalPaidPayments !== "—"
                  ? `₹${Number(patient.totalPaidPayments).toLocaleString("en-IN")}`
                  : "—"}
              </div>
              <div className="mt-1 text-sm font-medium text-[#677294]">
                Total Paid Payments
        ...
        <div className="flex gap-4 items-start">
          ...
          <Card
            shadow="none"
            radius="lg"
            className="flex-1 min-w-0 border border-line bg-surface"
          >
            <CardBody className="p-0">
              <div className="px-5 pt-4">
                <Tabs
                  ...
                  classNames={{
                    tabList:
                      "bg-transparent gap-0 p-0 border-b border-line",
                    tab:
                    ...
                    {isReportsLoading ? (
                      ...
                      <div className="relative">
                            ...
                            <div className="relative flex flex-col items-center pt-1">
                              <div
                                className={`h-6 w-6 rounded-full border-4 border-white shadow-sm flex items-center justify-center ${
                                  a.status?.toLowerCase().includes("confirm") ||
                              ...
                              {idx < appointments.length - 1 && (
                                <div className="absolute left-1/2 top-7 bottom-0 w-px -translate-x-1/2 bg-slate-200" />
                              )}
                            </div>
                            ...
                            <div className="flex flex-1 items-center justify-between min-w-0">
                              ...
                              <div className="flex items-center gap-4 shrink-0">
                                ...
                                <button
                                  ...
                                  onClick={() =>
                                    navigate(
                                      generatePath(APPT_VIEW_ROUTE, {
                                        id: a.id,
                                      }),
                                    )
                                  }
                                  className="rounded-lg border border-black/10 px-4 py-1.5 text-xs font-semibold text-primary hover:bg-slate-50 dark:hover:bg-white/5 transition"
                                >
                                  View Details
                                </button>
                              </div>
                        ...
                        {appointments.length === 0 && (
                          <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-line bg-slate-50/50 py-12">
                            ...
                            <p className="mt-1 text-xs text-[#677294]">
              ...
              <CardBody className="p-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Link
                    ...
                    className="flex flex-col items-center justify-center gap-2 rounded-xl border border-line py-5 px-3 hover:border-primary/30 hover:bg-primary/5 transition"
                  >
