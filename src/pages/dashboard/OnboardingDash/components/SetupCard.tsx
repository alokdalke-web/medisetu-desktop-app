...
interface SetupCardProps {
    ...
    actionDisabledMessage?: ReactNode;
    ...
    return (
        <Card className="relative rounded-2xl shadow-sm hover:shadow-md dark:hover:shadow-lg transition-all border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
            <CardBody className="flex flex-col h-full p-4">
                ...
                {/* Primary button */}
                <Tooltip
                    content={actionDisabledMessage}
                    isDisabled={!isActionDisabled || !actionDisabledMessage}
                    showArrow
                    placement="top"
                    closeDelay={0}
                >
                    <span className="block w-full">
                        <AppButton
                            ...
                            className="w-full font-outfit text-[12px] disabled:cursor-not-allowed disabled:opacity-55"
                        />
                    </span>
                </Tooltip>
