  ...
  const formBody = (
    <div className="space-y-5 max-h-[65vh] overflow-y-auto px-1">
      ...
      <Controller
        ...
        control={control}
        render={({ field }) => (
          <div className="flex items-center justify-between rounded-2xl bg-surface-muted px-4 py-3 border border-line">
            <div>
          ...
          render={({ field, fieldState }) => (
            <div>
              <DatePicker
                ...
                value={(field.value ? isoToZoned(field.value) : null) as any}
                onChange={(val: any) => {
                  if (val) {
                    field.onChange(zonedToIso(val));
                  } else {
                    field.onChange("");
                  }
                }}
                ...
                classNames={{
                  inputWrapper:
                    "border-1 border-border-color hover:border-primary/60 focus-within:border-primary",
                }}
              />
            </div>
          )}
