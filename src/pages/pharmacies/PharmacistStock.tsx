...
const PharmacistStock: React.FC = () => {
  ...
  const handleUploadBulkStock = async (file: File) => {
    const result = await importStock(file).unwrap();
    refetch();
    return result.data;
  };
  ...
  return (
    ...
    >
      ...
      <BulkUploadModal
        ...
        title="Upload Bulk Stock"
        type="stock"
        onUpload={handleUploadBulkStock}
        isUploading={isImportingStock}
      />
