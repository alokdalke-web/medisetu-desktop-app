            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-slate-100 p-4 dark:border-[#1e293b]">
                ...
                <p className="text-[13px] text-slate-600 leading-relaxed mb-3 dark:text-slate-400">
                  ...
                  appointment prescription drafts, and other personalization choices. Disabling
                  them means you'll need to set your preferences and unfinished drafts every time.
                </p>
                <div className="overflow-x-auto">
                  <table className="w-full text-[12px]">
                    <thead>
                    ...
                    <tbody className="text-slate-600 dark:text-slate-400">
                      ...
                      <tr className="border-b border-slate-50 dark:border-[#1e293b]">
                        <td className="py-2 font-mono text-[11px]">medisetu_appointment_prescription_draft:*</td>
                        <td className="py-2">Unfinished appointment prescription drafts</td>
                        <td className="py-2">Up to 14 days or until completion</td>
                      </tr>
                      <tr>
