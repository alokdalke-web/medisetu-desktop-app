...
// ─── Reception Dashboard: Doctor Queues widget ───────────────────────────────

export const doctorQueueTips: InfoTipItem[] = [
  {
    title: "One card per doctor",
    description:
      "Each doctor with appointments today gets a card showing how many patients they've seen, how many are still waiting, and their completion percentage.",
  },
  {
    title: "Click to filter",
    description:
      "Click a doctor to filter the whole dashboard (stats, table, and charts) to just their queue. Click the same doctor again to clear the filter.",
  },
  {
    title: "Sorted by load",
    description:
      "Doctors are ordered busiest-first, so the queue that needs attention is always at the top.",
  },
];
