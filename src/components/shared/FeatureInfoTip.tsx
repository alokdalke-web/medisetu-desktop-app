...
interface FeatureInfoTipProps {
  ...
  /** Custom link label */
  linkLabel?: string;
  /** Which trigger edge the popover anchors to. Use "right" when the trigger
      sits near the viewport's right edge so the popover opens leftward. */
  align?: "left" | "right";
}
      ...
      {isOpen && (
        <div
          className={[
            ...
            "absolute top-full z-50 mt-2 w-[300px] sm:w-[340px]",
