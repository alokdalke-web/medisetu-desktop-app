  ...
  return (
    <>
      <Modal
        ...
        size="lg"
        classNames={{
          // Must sit above ClinicalDrawer (overlay z-100 / panel z-101), otherwise
          // the drawer's overlay covers the modal and swallows every click.
          wrapper: "z-[200]",
          backdrop: "z-[199]",
            ...
            <ModalBody>
              <div className="relative px-5 pt-5 pb-5 sm:px-6 sm:pt-6 sm:pb-6">
                ...
                <div className="mt-5" ref={rootRef}>
                  {/* Open handlers live on the wrapper: HeroUI's Input routes onClick/onFocus
                      through react-aria and they never reach us. */}
                  <div
                    onMouseDownCapture={openDropdown}
