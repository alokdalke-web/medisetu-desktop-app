  ...
  showLockTooltip = false,
    ...
    const addButton = showLockTooltip ? (
      <button
        ...
        className={[
          ...
          !canEdit
            ...
            : "border-success/30 text-emerald-700 hover:bg-success/10",
        ].join(" ")}
      >
      ...
      <button
        type="button"
        onClick={onAdd}
        className="grid h-7 w-7 place-items-center rounded-full border border-success/30 text-emerald-700 hover:bg-success/10 transition"
      >
        <FiPlus className="h-4 w-4" />
      </button>
    );
